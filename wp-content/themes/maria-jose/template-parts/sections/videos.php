...
if ( ! $videos ) {
	$videos = array(
		array( 'id' => 'en3a9dWLkz4', 'title' => 'Punto Final', 'type' => 'Video oficial', 'duration' => '3:45' ),
		array( 'id' => 'DK_TUrA_RLU', 'title' => 'Libertad', 'type' => 'En vivo', 'duration' => '2:58' ),
		array( 'id' => 'MAvbt2J1hVQ', 'title' => 'Llorona Abajeña', 'type' => 'Acústico', 'duration' => '4:12' ),
		array( 'id' => 'XPa4nr0uSj4', 'title' => 'Chacareras', 'type' => 'Sesión', 'duration' => '3:09' ),
	);
}
$active = $videos[0];
?>
